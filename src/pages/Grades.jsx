              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="px-4 py-3 text-left text-xs sm:text-sm font-medium text-muted-foreground">Student Name</th>
                    <th className="px-4 py-3 text-left text-xs sm:text-sm font-medium text-muted-foreground">Status</th>
                    <th className="px-4 py-3 text-left text-xs sm:text-sm font-medium text-muted-foreground">Enrolled</th>
                  </tr>
                </thead>
                <tbody>
