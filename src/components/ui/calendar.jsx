...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-0 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        months: cn("relative flex flex-col gap-4 md:flex-row md:gap-8", defaultClassNames.months),
        ...
        weekday: cn(
          "text-muted-foreground w-9 select-none text-[0.8rem] font-normal text-center",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "h-9 w-9 p-0 text-sm font-normal rounded-md",
        "transition-colors",
